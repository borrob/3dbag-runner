...
def cityjsonbuilding_to_glb(features_path: Path, metadata_path: Path, output_path: Path, attribute_mapping: Optional[str] = None) -> None:
    ...
    command: list[str] = [
        ...
        '--grid-minz=-20',
        '--grid-maxz=300',
        "--color-building", "#EC7658",
        "--color-building-installation", "#EC7658",
        "--color-building-part", "#EC7658",
        "--grid-cellsize=250",
    ]
...
def cityjsonterrain_to_glb(features_path: Path, metadata_path: Path, output_path: Path, attribute_mapping: Optional[str] = None) -> None:
    ...
    command: list[str] = [
        ...
        "--grid-maxz=400",
        "--color-bridge", "#BBBBB8",
        "--color-bridge-construction-element", "#BBBBB8",
        "--color-bridge-installation", "#BBBBB8",
        "--color-bridge-part", "#BBBBB8",
        "--color-city-furniture", "#BBBBB8",
        "--color-generic-city-object", "#BBBBB8",
        "--color-land-use", "#C0D9B4",
        "--color-plant-cover", "#CCF085",
        "--color-railway", "#BBBBB8",
        "--color-road", "#BBBBB8",
        "--color-solitary-vegetation-object", "#CCF085",
        "--color-tin-relief", "#CCF085",
        "--color-transport-square", "#BBBBB8",
        "--color-tunnel", "#BBBBB8",
        "--color-tunnel-installation", "#BBBBB8",
        "--color-tunnel-part", "#BBBBB8",
...
def prepare_files(input_folder: str, output_folder: Path) -> Optional[str]: #This function does too much, split it
    ...
    with ThreadPoolExecutor(max_workers=32) as executor:
        tasks = []
        for filename, uri in handler.list_files_shallow(input_folder, regex="(i?)^.*\\.city\\.json$"):
            if schema == None:
